...
- Some system configurations or application configuration files are symbolic links to the corresponding directories under this project. The link allowlist is declared in `nix/home/dotfiles.nix`.
...
- After adding or modifying any configuration, complete this documentation checklist, because the README and the per-directory guidance are the only place the sync layout is written down:
