...
<required_reading>
@/Users/areslee/.config/opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/areslee/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
