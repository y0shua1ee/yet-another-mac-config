...
```bash
node "/Users/areslee/.config/opencode/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/Users/areslee/.config/opencode/get-shit-done/bin/gsd-tools.cjs" validate health
```
